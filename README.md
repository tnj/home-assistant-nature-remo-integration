...
| TV | `remote` (every IR button via `remote.send_command`) + all API-enumerated buttons as button entities (broadcast/input shortcuts enabled; the rest disabled by default) |
